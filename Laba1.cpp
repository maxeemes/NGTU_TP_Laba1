...
//TODO: Сделать основной код простенького интерфейса для структуры  
...
int main()
{
	...
	do
	{
		...
		int M = ReadConsoleNum("Введите количество монет гербами вниз...", 14);
		int N = ReadConsoleNum("Введите количество монет гербами вверх...", 14);
		int L = ReadConsoleNum("Введите количество монет гербами вверх после выполнения...", 14);
		int S = ReadConsoleNum("Введите размер шага...", 14);
		int K = ReadConsoleNum("Введите количество шагов...", 14);
